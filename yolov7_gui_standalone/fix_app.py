"""
app.py 파일을 Professional GUI용으로 완전 수정
"""

def fix_app_py():
    """app.py를 Professional GUI용으로 수정"""
...
'''
    ...
    if app_file.exists():
        # 백업
        shutil.copy(app_file, "src/app_old.py.backup")
        print("✅ 기존 app.py를 backup으로 저장")
    
    # 새로운 app.py 작성
    with open(app_file, 'w', encoding='utf-8') as f:
        f.write(new_app_code)
    
    print("✅ app.py를 Professional GUI용으로 완전 교체")
    print("")
    print("🎉 app.py 수정 완료!")
    print("🚀 이제 python main.py 실행 시 Professional GUI가 실행됩니다!")
